          ...
          <div class="row">
              ...
              <div class="p-5">
                ...
                <div class="judul">
                  ...
                  <div class="text-center">
                    <h1 class="h2 text-white mb-4 font-weight-bold">SISTEM</h1>
                  </div>
                  <div class="text-center">
                    <h1 class="h2 text-white mb-4 font-weight-bold">PENDATAAN ODP</h1>
                  </div>
                  <hr class="bg-white">
                </div>
            ...
            <div class="col-lg-6">
              <div class="p-5">
                ...
                <br>
                <div class="text-center">
                  <h1 class="h4 text-gray-900 text-uppercase">Login Akun</h1>
                  <hr class="bg-white">
                  <br>
                  <br>
                </div>
                <form class="user">
                  ...
                  <a href="#" onclick="proses_login()" id="login" class="btn btn-dark btn-user btn-block shadow text-uppercase">
                    Login
                  </a>
                  <br>
                  <br>
