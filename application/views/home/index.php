...
<div class="container-fluid">
  ...
  <div class="row">
    <?php if ($this->session->userdata('login_session')['level'] == 'admin') : ?>
      <div class="col-xl col-md mb-3" id="barang">
        <div class="card border-left-dark shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Jumlah PT2
                </div>
                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jmlpt2 ?> Data</div>
              </div>
              <div class="col-auto">
      ...
      <div class="col-xl col-md mb-3" id="barang">
        <div class="card border-left-dark shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Jumlah ODPS
                </div>
                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jmlodps ?> Data</div>
              </div>
              <div class="col-auto">
                <i class="fas fa-box fa-2x text-gray-300"></i>
              </div>
      ...
      <div class="col-xl col-md mb-3" id="user">
  ...
  <div class="row">
    ...
    <?php if ($this->session->userdata('login_session')['level'] == 'admin') : ?>
      <div class="col-xl-12 col-lg-12">
        <div class="card border-bottom-dark shadow mb-4" id="grafik">
          <!-- Card Header - Dropdown -->
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-dark">
            <h6 class="m-0 font-weight-bold border-0 text-white">Total Data PT2 dan ODPS Perbulan</h6>
