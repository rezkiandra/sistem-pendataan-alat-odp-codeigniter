...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-5">
        ...
        <a href="<?= base_url() ?>profile/ubah/<?= $this->session->userdata('login_session')['id_user'] ?>" class="btn btn-primary btn-icon-split">
                            ...
                            <center>
                                <div class="form-group">
                                    <h3 class="h3 mb-0 text-gray-800 d-sm-flex justify-content-center">
                                        ...
                                        &nbsp;
                                        <div class="div text-capitalize" id="status">-</div>
                                    </h3>
                                </div>
                                <!-- Divider -->
                                <div class="col-8 mb-4">
                        ...
                        <div class="col-lg-12">
                            <center>
                                <h3 class="h3 mb-0 text-gray-800 d-sm-flex justify-content-center">
                                    ...
                                    &nbsp;
                                    <div class="div text-capitalize" id="level">-</div>
                                </h3>
                                <div class="col-8 mb-4">
                                    <center>
                                        <hr class="sidebar-divider">
